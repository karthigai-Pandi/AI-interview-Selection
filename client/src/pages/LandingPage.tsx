  ...
  return (
    <div className="space-y-24 pb-24">
      ...
      <section className="relative px-6 sm:px-10">
        ...
        <div className="relative mx-auto grid max-w-7xl gap-16 lg:grid-cols-[1.1fr_0.9fr] lg:items-center mt-12">
          <motion.div variants={containerVariants} initial="hidden" animate="visible" className="space-y-8">
            <motion.div variants={itemVariants} className="inline-flex items-center gap-2 rounded-full bg-primary/10 border border-primary/20 px-4 py-2 text-sm text-primary-100 backdrop-blur-md">
            ...
            <motion.h1 variants={itemVariants} className="max-w-3xl text-5xl font-bold tracking-tight text-white sm:text-7xl leading-tight">
              Build the ideal hiring workflow with <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent to-primary">AI-powered candidate journeys</span>.
            </motion.h1>
          ...
          <motion.div initial={{ opacity: 0, x: 40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, delay: 0.2 }} className="relative">
            ...
            <div className="relative overflow-hidden rounded-[3rem] border border-white/10 bg-surface/90 p-8 shadow-2xl shadow-surface/20 backdrop-blur-xl">
              ...
              <div className="space-y-6">
                  <div className="rounded-[2rem] bg-surface/90 p-6 border border-white/5">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div className="rounded-[2rem] bg-surface/90 p-4 border border-white/5">
                ...
                <div className="rounded-[2rem] bg-gradient-to-br from-surface/90 via-primary/90 to-surface/90 p-5 border border-white/5">
      ...
      <section id="features" className="mx-auto max-w-7xl px-6 sm:px-10 grid gap-6 lg:grid-cols-2 mt-12">
        <div className="glass-panel space-y-8 rounded-[2.5rem] p-10 bg-surface/80 border border-white/10">
          <div>
          ...
          <div className="grid gap-4 sm:grid-cols-2 pt-4">
            <div className="glass-panel-hover rounded-3xl bg-surface/80 p-6 border border-white/5">
              ...
              <p className="mt-2 text-sm text-slate-300">Adaptive questioning and instant coaching feedback.</p>
            </div>
            <div className="glass-panel-hover rounded-3xl bg-surface/80 p-6 border border-white/5">
              <div className="h-10 w-10 bg-accent/20 rounded-full flex items-center justify-center mb-4">
                <ChartBarIcon className="w-5 h-5 text-accent" />
              </div>
              <h3 className="text-lg font-semibold text-white">Pipeline visibility</h3>
              <p className="mt-2 text-sm text-slate-300">See every stage and health score in a single dashboard.</p>
            </div>
          </div>
        </div>
